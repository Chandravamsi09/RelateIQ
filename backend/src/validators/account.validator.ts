/**
 * RelateIQ Domain Validator: AccountValidationSchema
...
export class AccountValidator {
  public static validateCreate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateAccountInput } {
    const errors: string[] = [];
    ...
    const sanitized: ValidateAccountInput = {
  ...
  public static validateUpdate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateAccountInput } {
    const errors: string[] = [];
    if (!input || typeof input !== 'object') {
