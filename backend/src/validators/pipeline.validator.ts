/**
 * RelateIQ Domain Validator: PipelineValidationSchema
...
export class PipelineValidator {
  public static validateCreate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidatePipelineInput } {
    const errors: string[] = [];
    ...
    const sanitized: ValidatePipelineInput = {
  ...
  public static validateUpdate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidatePipelineInput } {
    const errors: string[] = [];
    if (!input || typeof input !== 'object') {
