/**
 * RelateIQ Domain Validator: UserValidationSchema
...
export class UserValidator {
  public static validateCreate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateUserInput } {
    const errors: string[] = [];
  ...
  public static validateUpdate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateUserInput } {
    const errors: string[] = [];
    if (!input || typeof input !== 'object') {
