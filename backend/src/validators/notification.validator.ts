/**
 * RelateIQ Domain Validator: NotificationValidationSchema
...
export class NotificationValidator {
  public static validateCreate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateNotificationInput } {
    const errors: string[] = [];
    ...
    const sanitized: ValidateNotificationInput = {
  ...
  public static validateUpdate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateNotificationInput } {
    const errors: string[] = [];
    if (!input || typeof input !== 'object') {
