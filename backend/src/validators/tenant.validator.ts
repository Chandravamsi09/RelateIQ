/**
 * RelateIQ Domain Validator: TenantValidationSchema
...
export class TenantValidator {
  public static validateCreate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateTenantInput } {
    const errors: string[] = [];
    ...
    const sanitized: ValidateTenantInput = {
  ...
  public static validateUpdate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateTenantInput } {
    const errors: string[] = [];
    if (!input || typeof input !== 'object') {
