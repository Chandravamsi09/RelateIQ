/**
 * RelateIQ Domain Validator: InvoiceItemValidationSchema
...
export class InvoiceItemValidator {
  public static validateCreate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateInvoiceItemInput } {
    const errors: string[] = [];
    ...
    const sanitized: ValidateInvoiceItemInput = {
  ...
  public static validateUpdate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateInvoiceItemInput } {
    const errors: string[] = [];
    if (!input || typeof input !== 'object') {
