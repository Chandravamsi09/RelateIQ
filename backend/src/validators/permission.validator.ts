/**
 * RelateIQ Domain Validator: PermissionValidationSchema
...
export class PermissionValidator {
  public static validateCreate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidatePermissionInput } {
    const errors: string[] = [];
    ...
    const sanitized: ValidatePermissionInput = {
  ...
  public static validateUpdate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidatePermissionInput } {
    const errors: string[] = [];
    if (!input || typeof input !== 'object') {
