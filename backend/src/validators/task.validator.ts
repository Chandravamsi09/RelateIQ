/**
 * RelateIQ Domain Validator: TaskValidationSchema
...
export class TaskValidator {
  public static validateCreate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateTaskInput } {
    const errors: string[] = [];
    ...
    const sanitized: ValidateTaskInput = {
  ...
  public static validateUpdate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateTaskInput } {
    const errors: string[] = [];
    if (!input || typeof input !== 'object') {
