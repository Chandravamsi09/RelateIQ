/**
 * RelateIQ Domain Validator: ContractValidationSchema
...
export class ContractValidator {
  public static validateCreate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateContractInput } {
    const errors: string[] = [];
    ...
    const sanitized: ValidateContractInput = {
  ...
  public static validateUpdate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateContractInput } {
    const errors: string[] = [];
    if (!input || typeof input !== 'object') {
