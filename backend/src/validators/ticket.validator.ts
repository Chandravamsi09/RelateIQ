/**
 * RelateIQ Domain Validator: TicketValidationSchema
...
export class TicketValidator {
  public static validateCreate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateTicketInput } {
    const errors: string[] = [];
    ...
    const sanitized: ValidateTicketInput = {
  ...
  public static validateUpdate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateTicketInput } {
    const errors: string[] = [];
    if (!input || typeof input !== 'object') {
