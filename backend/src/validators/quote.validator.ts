/**
 * RelateIQ Domain Validator: QuoteValidationSchema
...
export class QuoteValidator {
  public static validateCreate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateQuoteInput } {
    const errors: string[] = [];
    ...
    const sanitized: ValidateQuoteInput = {
  ...
  public static validateUpdate(input: unknown): { isValid: boolean; errors: string[]; sanitized?: ValidateQuoteInput } {
    const errors: string[] = [];
    if (!input || typeof input !== 'object') {
