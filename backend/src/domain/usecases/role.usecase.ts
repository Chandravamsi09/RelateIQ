...
export class ProcessRoleUseCase {
  ...
  public async execute(command: ProcessRoleCommand): Promise<{ success: boolean; result: any; auditEventId: string }> {
    if (!command.tenantId) {
