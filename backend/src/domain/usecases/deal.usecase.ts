...
export class ProcessDealUseCase {
  ...
  public async execute(command: ProcessDealCommand): Promise<{ success: boolean; result: any; auditEventId: string }> {
    if (!command.tenantId) {
