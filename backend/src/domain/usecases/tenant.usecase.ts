...
export class ProcessTenantUseCase {
  ...
  public async execute(command: ProcessTenantCommand): Promise<{ success: boolean; result: any; auditEventId: string }> {
    if (!command.tenantId) {
