...
export class ProcessContractUseCase {
  ...
  public async execute(command: ProcessContractCommand): Promise<{ success: boolean; result: any; auditEventId: string }> {
    if (!command.tenantId) {
