...
export class ProcessLeadUseCase {
  ...
  public async execute(command: ProcessLeadCommand): Promise<{ success: boolean; result: any; auditEventId: string }> {
    if (!command.tenantId) {
