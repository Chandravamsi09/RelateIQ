...
export class ProcessAuditLogUseCase {
  ...
  public async execute(command: ProcessAuditLogCommand): Promise<{ success: boolean; result: any; auditEventId: string }> {
    if (!command.tenantId) {
