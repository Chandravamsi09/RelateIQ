...
export interface CallLogAnalyticsPanelProps {
  tenantId?: string;
  timeRange?: '7d' | '30d' | '90d' | '1y';
}

export const CallLogAnalyticsPanel: React.FC<CallLogAnalyticsPanelProps> = ({ tenantId = 'tenant-acme-corp', timeRange = '30d' }) => {
  ...
  return (
    <div className="p-5 bg-slate-950 border border-slate-800 rounded-2xl space-y-4">
      <div className="flex justify-between items-center pb-3 border-b border-slate-800">
        <div>
          <h4 className="text-sm font-bold text-slate-200">CallLog Telemetry & Metrics</h4>
