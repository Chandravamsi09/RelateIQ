...
/**
 * RelateIQ Enterprise Design System - Alert Component
...
export const Alert: React.FC<AlertProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-alert transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
