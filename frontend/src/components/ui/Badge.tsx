...
/**
 * RelateIQ Enterprise Design System - Badge Component
...
export const Badge: React.FC<BadgeProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-badge transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
