...
/**
 * RelateIQ Enterprise Design System - PipelineStep Component
...
export const PipelineStep: React.FC<PipelineStepProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-pipelinestep transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
