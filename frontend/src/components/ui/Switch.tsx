...
/**
 * RelateIQ Enterprise Design System - Switch Component
...
export const Switch: React.FC<SwitchProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-switch transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
