...
/**
 * RelateIQ Enterprise Design System - TicketBadge Component
...
export const TicketBadge: React.FC<TicketBadgeProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-ticketbadge transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
