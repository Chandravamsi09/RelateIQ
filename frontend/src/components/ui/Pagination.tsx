...
/**
 * RelateIQ Enterprise Design System - Pagination Component
...
export const Pagination: React.FC<PaginationProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-pagination transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
