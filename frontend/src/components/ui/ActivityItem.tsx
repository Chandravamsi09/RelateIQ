...
/**
 * RelateIQ Enterprise Design System - ActivityItem Component
...
export const ActivityItem: React.FC<ActivityItemProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-activityitem transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
