...
/**
 * RelateIQ Enterprise Design System - ProgressBar Component
...
export const ProgressBar: React.FC<ProgressBarProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-progressbar transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
