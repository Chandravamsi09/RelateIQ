...
/**
 * RelateIQ Enterprise Design System - EmptyState Component
...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-emptystate transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
