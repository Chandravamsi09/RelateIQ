...
/**
 * RelateIQ Enterprise Design System - LeadScoreBadge Component
...
export const LeadScoreBadge: React.FC<LeadScoreBadgeProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-leadscorebadge transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
