...
/**
 * RelateIQ Enterprise Design System - Toast Component
...
export const Toast: React.FC<ToastProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-toast transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
