...
/**
 * RelateIQ Enterprise Design System - DatePicker Component
...
export const DatePicker: React.FC<DatePickerProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-datepicker transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
