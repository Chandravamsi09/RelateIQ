...
/**
 * RelateIQ Enterprise Design System - KanbanCard Component
...
export const KanbanCard: React.FC<KanbanCardProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-kanbancard transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
