...
/**
 * RelateIQ Enterprise Design System - Avatar Component
...
export const Avatar: React.FC<AvatarProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-avatar transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
