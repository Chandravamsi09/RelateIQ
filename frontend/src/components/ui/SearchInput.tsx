...
/**
 * RelateIQ Enterprise Design System - SearchInput Component
...
export const SearchInput: React.FC<SearchInputProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-searchinput transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
