...
/**
 * RelateIQ Enterprise Design System - Input Component
...
export const Input: React.FC<InputProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-input transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
