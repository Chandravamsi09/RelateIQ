...
/**
 * RelateIQ Enterprise Design System - Textarea Component
...
export const Textarea: React.FC<TextareaProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-textarea transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
