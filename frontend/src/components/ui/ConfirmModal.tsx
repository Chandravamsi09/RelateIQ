...
/**
 * RelateIQ Enterprise Design System - ConfirmModal Component
...
export const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-confirmmodal transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
