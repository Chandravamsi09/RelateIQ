...
/**
 * RelateIQ Enterprise Design System - Table Component
...
export const Table: React.FC<TableProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-table transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
