...
/**
 * RelateIQ Enterprise Design System - Drawer Component
...
export const Drawer: React.FC<DrawerProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-drawer transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
