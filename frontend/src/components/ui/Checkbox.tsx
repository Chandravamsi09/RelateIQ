...
/**
 * RelateIQ Enterprise Design System - Checkbox Component
...
export const Checkbox: React.FC<CheckboxProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-checkbox transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
