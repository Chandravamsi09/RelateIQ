...
/**
 * RelateIQ Enterprise Design System - Skeleton Component
...
export const Skeleton: React.FC<SkeletonProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-skeleton transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
