...
/**
 * RelateIQ Enterprise Design System - Select Component
...
export const Select: React.FC<SelectProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-select transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
