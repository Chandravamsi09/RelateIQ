...
/**
 * RelateIQ Enterprise Design System - KanbanColumn Component
...
export const KanbanColumn: React.FC<KanbanColumnProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-kanbancolumn transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
