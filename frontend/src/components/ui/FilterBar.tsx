...
/**
 * RelateIQ Enterprise Design System - FilterBar Component
...
export const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-filterbar transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
