...
/**
 * RelateIQ Enterprise Design System - Breadcrumbs Component
...
export const Breadcrumbs: React.FC<BreadcrumbsProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-breadcrumbs transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
