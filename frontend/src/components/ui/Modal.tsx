...
/**
 * RelateIQ Enterprise Design System - Modal Component
...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-modal transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
