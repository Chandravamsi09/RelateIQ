...
/**
 * RelateIQ Enterprise Design System - Dropdown Component
...
export const Dropdown: React.FC<DropdownProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-dropdown transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
