...
/**
 * RelateIQ Enterprise Design System - Tabs Component
...
export const Tabs: React.FC<TabsProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-tabs transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
