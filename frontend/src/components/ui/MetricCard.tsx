...
/**
 * RelateIQ Enterprise Design System - MetricCard Component
...
export const MetricCard: React.FC<MetricCardProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-metriccard transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
