...
/**
 * RelateIQ Enterprise Design System - WorkflowNode Component
...
export const WorkflowNode: React.FC<WorkflowNodeProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-workflownode transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
