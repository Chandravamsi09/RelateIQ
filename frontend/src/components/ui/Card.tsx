...
/**
 * RelateIQ Enterprise Design System - Card Component
...
export const Card: React.FC<CardProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-card transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
