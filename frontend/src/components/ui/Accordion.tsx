...
/**
 * RelateIQ Enterprise Design System - Accordion Component
...
export const Accordion: React.FC<AccordionProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-accordion transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
