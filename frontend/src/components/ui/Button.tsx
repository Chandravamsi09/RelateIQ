...
/**
 * RelateIQ Enterprise Design System - Button Component
...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <div
      ...
      className={`relateiq-button transition-all duration-200 font-medium ${getVariantStyles()} ${getSizeStyles()} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
      {...props}
    >
